        ...
        >
          <div>
            <div className="flex items-center bg-slate-50 dark:bg-[#101e23] p-4 pb-2 justify-between">
              <div className="text-[#0d141c] dark:text-white flex size-12 shrink-0 items-center" data-icon="ArrowLeft" data-size="24px" data-weight="regular">
            ...
            <p 
              className="text-[#49739c] dark:text-[#90bccb] text-sm font-normal leading-normal pb-3 pt-1 px-4 underline cursor-pointer"
